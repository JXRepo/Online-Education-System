...
/**
 * @description Course index management interface implementation
 * @author Mr.M
 * @version 1.0
 */
@Slf4j
...
public class IndexServiceImpl implements IndexService {
 ...
 public Boolean addCourseIndex(String indexName,String id,Object object) {
  ...
  //Specify the index document content
  indexRequest.source(jsonString,XContentType.JSON);
  //Indexing the response object
  ...
  try {
   ...
   e.printStackTrace();
   XueChengPlusException.cast("Error adding index");
  }
 ...
 public Boolean updateCourseIndex(String indexName,String id,Object object) {
  ...
  try {
   ...
   e.printStackTrace();
   XueChengPlusException.cast("Error updating index");
  }
 ...
 public Boolean deleteCourseIndex(String indexName,String id) {
  ...
  try {
   ...
   e.printStackTrace();
   XueChengPlusException.cast("Error deleting index");
  }
